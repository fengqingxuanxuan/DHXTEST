...
import com.tiantianle.adapter.JinxingAdapterIndinan;
...
public class JingXingFragmentIndinanremb extends Fragment {
    ...
    protected PullToRefreshListView mPullRefreshListFramJinxingIndinan;
    private List<AllIndianaBean.BizContentBean> mAllIndianaBeen=new ArrayList<>();
    private List<AllIndianaBean.BizContentBean> res;
    private int page=1;
    private int yvshu;
    private int shang;
    private JinxingAdapterIndinan mJinxingAdapterIndinan;
    ...
    private void Pullto(){
        mPullRefreshListFramJinxingIndinan.setMode(PullToRefreshBase.Mode.BOTH);
        mPullRefreshListFramJinxingIndinan.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
        ...
        ShowTotalcount showTotalcount = new ShowTotalcount() {
            @Override
        ...
        mJinxingAdapterIndinan = new JinxingAdapterIndinan(showTotalcount, myInterface);
        mPullRefreshListFramJinxingIndinan.setAdapter(mJinxingAdapterIndinan);
        SimpleDateFormat format=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date curDate    =   new Date(System.currentTimeMillis());
        String time=format.format(curDate);
        ILoadingLayout loadingLayoutProxy = mPullRefreshListFramJinxingIndinan.getLoadingLayoutProxy();
            ...
            public void onSuccess(String result) {
                ...
                if (allIndianaBean.getState().equals("success")) {
                    ...
                    if(isUP){
                        ...
                        mJinxingAdapterIndinan.setList(mAllIndianaBeen);
                        mJinxingAdapterIndinan.notifyDataSetChanged();
                    }else{
                        mJinxingAdapterIndinan.setList(res);
                        mJinxingAdapterIndinan.notifyDataSetChanged();
                    }
                    mPullRefreshListFramJinxingIndinan.onRefreshComplete();
    ...
    private void initView(View rootView) {
        mPullRefreshListFramJinxingIndinan = (PullToRefreshListView) rootView.findViewById(R.id.pull_refresh_list_fram_jinxingIndinan);
