...
public class AllAdapterIndinan extends BaseAdapter {
    ...
    private String nain;
    public AllAdapterIndinan(ShowTotalcount showTotalcount, MyInterface myInterface) {
    ...
    public View getView(int i, View convertView, final ViewGroup parent) {
        ...
        if (sta == 0) {
            ...
            viewHolder.mLlQuanbuIndinanremb.setVisibility(View.VISIBLE);
